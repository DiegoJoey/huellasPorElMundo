        ...
        <div class="row">
            @forelse($animals as $animal)
                ...
                <div class="col-md-4 mb-4 post">
                    <div class="card h-100" data-bs-toggle="modal" data-bs-target="#animalModal{{ $animal->id }}"
                ...
                <!-- Modal -->
                <div class="modal fade" id="animalModal{{ $animal->id }}" tabindex="-1"
                    aria-labelledby="animalModalLabel{{ $animal->id }}" aria-hidden="true">
                    <div class="modal-dialog modal-lg modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <img src="{{ asset($animal->image_path) }}" class="img-fluid"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="d-flex gap-2 mt-3">
                                            @if (auth()->check() && auth()->user()->role === 'admin')
                                                <form action="/destroy/{{ $animal->id }}" method="POST"
                                            ...
                                            @endif
                                            @auth
                                                <form action="/adoptar/{{ $animal->id }}" method="GET"
                                                    style="display:inline;">
                                                    @csrf
