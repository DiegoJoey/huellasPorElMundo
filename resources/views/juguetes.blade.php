...
<div class="container mt-4">
    ...
    <form action="/donar/juguetes" method="POST">
        @csrf

        <input type="hidden" name="category" value="juguetes">
        <input type="hidden" name="user_id" value="{{$user->id}}">

        <div class="mb-3">
            <label for="item" class="form-label">¿Qué juguetes quieres donar?</label>
...
@push('scripts')
    <script src="{{ asset('resources/js/juguetes-form-validation.js') }}"></script>
@endpush
